...
Mesmo não sendo objeto de estudo aqui a avaliação qualitativa de PPC's, os resultados obtidos demonstram que os índices quantitaivos desenvolvidos são de 
...
e poder ter noção como tais mudanças podem afetar problemas acadêmicos como desistência trancamento, desistência ou abandono de cursos. \\
